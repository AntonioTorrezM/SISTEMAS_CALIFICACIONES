        ...
        <div class="container">
            ...
            <form action="UsuarioControlador" method="post" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="estudiante" value="${usuario.estudiante}" placeholder="Escriba el nombre del estudiante">                    
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ci" value="${usuario.ci}" placeholder="C.I.">
                </div>
